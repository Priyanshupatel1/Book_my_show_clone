...
function NavMd(){
    ...
    <img 
    src="https://i.ibb.co/zPBYW3H/imgbin-bookmyshow-office-android-ticket-png.png"//add src book my show
    alt= "logo"
...
function NavLg(){
    ...
    <div className='container flex mx-auto items-center px-4 justify-between '>
        ...
        <div className='flex items-center gap-3 '>
            <span className='text-gray-200 text-base flex items-center cursor-pointer hover:text-white'>Delhi NCR</span>
